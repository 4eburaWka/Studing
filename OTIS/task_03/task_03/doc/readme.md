...
![Построение по матрице смежности](images/8.png)

## Найти гамильтонов цикл для графа
![Гамильтонов цикл](images/9.png)

## Можем работать одновременно с несколькими графами
![MDI](images/10.png)

## Можем работать с буфером обмена
1) Вырезаем
![Вырезание](images/11.png)
![Результат](images/12.png)
2) Вставляем
![Вставка](images/13.png)
